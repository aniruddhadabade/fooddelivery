...
public class RestaurantDetailsDto {
	...
	public RestaurantDetailsDto(long restaurentId, String rname, String raddress, String contact_number, String email,
	...
	public String toString() {
		return "RestaurantDetailsDto [restaurentId=" + restaurentId + ", rname=" + rname + ", raddress=" + raddress
